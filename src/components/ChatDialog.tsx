        ...
        <div className="h-96 overflow-y-auto p-4 space-y-3">
          {isInitializing || isLoading ? (
            ...
            <>
              ...
              {Array.from(pendingMessages.values()).map((msg) => {
                const isOwnMessage = msg.senderUserId === user?.id;
                return (
                  <div
                    key={msg.id}
                    ...
                    <div
                      className={cn(
                        ...
                        isOwnMessage
                          ...
                          : "bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 opacity-60"
                      )}
                    >
                      <p className="text-sm break-words">{msg.content}</p>
                      {msg.createdAt && (
